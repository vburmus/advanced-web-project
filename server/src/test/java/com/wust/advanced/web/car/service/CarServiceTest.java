...
class CarServiceTest {
    ...
    void createCarExists() {
        ...
        ItemExistsException exception = assertThrows(ItemExistsException.class, () -> carService.create(carDto));
    ...
    void readByIdNotFound() {
        ...
        ItemNotFoundException exception = assertThrows(ItemNotFoundException.class, () -> carService.readById(1L));
    ...
    void updateLocationCarNotFound() {
        ...
        ItemNotFoundException exception = assertThrows(ItemNotFoundException.class, () -> carService.updateLocation(locationDto, 1L));
    ...
    void assignDriverCarNotFound() {
        ...
        ItemNotFoundException exception = assertThrows(ItemNotFoundException.class, () -> carService.assignDriver(1L, 1L));
