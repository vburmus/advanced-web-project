...
public class DriverService {
    ...
    public static final String DRIVER_ALREADY_EXISTS = "Driver with license %s:%s already exists";
    ...
    public DriverDto create(DriverDto driverDto) {
        ...
        if (isDriverExists(driver))
            throw new ItemNotFoundException(String.format(DRIVER_ALREADY_EXISTS,
